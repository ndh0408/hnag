  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center gap-6 p-8">
      ...
      <div className="flex gap-3">
        ...
        {/* TODO: build a dedicated /onboarding flow; for now route owners to login. */}
        <Link href="/login" className="px-6 py-3 rounded-full border-2 border-primary text-primary font-medium hover:bg-primary/5">
          Đăng ký quán mới
        </Link>
      </div>
    </main>
